                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php
                                       ...
                                       // $row_vieworder=$results = DB::table('itemorders')
                                              //  ->join('orders', 'itemorders.ordID', '=', 'orders.ordID')
                                              //  ->select('orders.ordID','orders.ordDate','orders.DueDate','orders.Quantity','orders.status')

                                               //  ->orWhere(function($query)
                                              //  {
                                               // $query->where('itemorders.custID', '=', Auth::user()->email);

                                              //  })
                                               // ->get();

                                //foreach($row_vieworder as $row){
